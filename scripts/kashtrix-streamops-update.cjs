 ...
 * Usage:
 *   node scripts/kashtrix-streamops-update.cjs [--check] [--force] [--version <v>]
...
`);
    ...
    log(`Current Software Version: Kashtrix StreamOps v2.4.0 (Build 2026-08-26)`);
    ...
    try {
        ...
        log('Synchronizing Prisma & MySQL/SQLite storage engines...');
        try {
